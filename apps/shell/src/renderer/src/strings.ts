...
export const strings = {
  zh: {
    ...
    accountSignOut: '退出登录',
    accountRecharge: '充值',
    accountErrNotConfigured: '账号服务未配置',
    accountErrBusy: '正在登录中，请稍候',
    accountErrCanceled: '登录已取消',
    accountErrTimeout: '登录超时，请重试',
    accountErrFailed: '登录失败，请重试',
    accountErrExpired: '登录已过期，请重新登录',
    accountSection: '账号',
    accountSignedOut: '未登录',
    accountBalance: '余额',
    accountMonthUsed: '本月已用',
    accountLowBalance: '余额不足，充值后可继续使用 AI 功能',
    accountManagedNote: '已登录方塘账号，对话将按用量从余额扣费。',
    // Sidebar navigation
    navRecent: '最近',
    navStarred: '收藏',
    ...
    setSecAbout: '关于',
    setSecSkills: '技能',
    setSkillsDesc: '选择各编辑器 AI 对话窗口中可用的内置生成技能',
    setWebsite: '官网',
    setVisitSite: '访问官网',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服务商',
  ...
  en: {
    ...
    accountRecharge: 'Top up',
    accountErrNotConfigured: 'Account service not configured',
    accountErrBusy: 'Sign-in already in progress',
    accountErrCanceled: 'Sign-in canceled',
    accountErrTimeout: 'Sign-in timed out, please retry',
    accountErrFailed: 'Sign-in failed, please retry',
    accountErrExpired: 'Session expired, please sign in again',
    accountSection: 'Account',
    accountSignedOut: 'Not signed in',
    accountBalance: 'Balance',
    accountMonthUsed: 'Used this month',
    accountLowBalance: 'Balance is low — top up to keep using AI features',
    accountManagedNote: 'Signed in to your Fangtang account — chats are billed from your balance by usage.',
    navRecent: 'Recent',
    navStarred: 'Starred',
    ...
    setSecAbout: 'About',
    setSecSkills: 'Skills',
    setSkillsDesc: 'Choose which built-in generation skills appear in each editor’s AI chat',
    setWebsite: 'Website',
    setVisitSite: 'Visit website',
  ...
  ja: {
    ...
    accountRecharge: 'チャージ',
    accountErrNotConfigured: 'アカウントサービス未設定',
    accountErrBusy: 'サインイン中です',
    accountErrCanceled: 'サインインをキャンセルしました',
    accountErrTimeout: 'サインインがタイムアウトしました',
    accountErrFailed: 'サインインに失敗しました',
    accountErrExpired: 'セッションの有効期限が切れました',
    accountSection: 'アカウント',
    accountSignedOut: '未サインイン',
    accountBalance: '残高',
    accountMonthUsed: '今月の使用額',
    accountLowBalance: '残高が不足しています。チャージすると AI 機能を引き続きご利用いただけます',
    accountManagedNote: '方塘アカウントでサインイン中です。チャットは使用量に応じて残高から課金されます。',
    // Sidebar navigation
    navRecent: '最近使用',
    navStarred: 'お気に入り',
    ...
    setSecAbout: '情報',
    setSecSkills: 'スキル',
    setSkillsDesc: '各エディターの AI チャットで使える内蔵生成スキルを選択します',
    setWebsite: '公式サイト',
    setVisitSite: 'サイトを見る',
    setSecAiModel: 'AIモデル',
  ...
  ko: {
    ...
    accountSignOut: '로그아웃',
    accountRecharge: '충전',
    accountErrNotConfigured: '계정 서비스 미설정',
    accountErrBusy: '로그인 진행 중입니다',
    accountErrCanceled: '로그인이 취소되었습니다',
    accountErrTimeout: '로그인 시간이 초과되었습니다',
    accountErrFailed: '로그인에 실패했습니다',
    accountErrExpired: '세션이 만료되었습니다',
    accountSection: '계정',
    accountSignedOut: '로그인되지 않음',
    accountBalance: '잔액',
    accountMonthUsed: '이번 달 사용액',
    accountLowBalance: '잔액이 부족합니다. 충전하면 AI 기능을 계속 사용할 수 있습니다',
    accountManagedNote: 'Fangtang 계정으로 로그인됨 — 대화는 사용량에 따라 잔액에서 청구됩니다.',
    // Sidebar navigation
    navRecent: '최근 사용',
    navStarred: '즐겨찾기',
    ...
    setSecAbout: '정보',
    setSecSkills: '스킬',
    setSkillsDesc: '각 편집기 AI 채팅에서 사용할 내장 생성 스킬을 선택합니다',
    setWebsite: '웹사이트',
    setVisitSite: '웹사이트 방문',
    setSecAiModel: 'AI 모델',
    setAiProvider: '제공업체',
    setAiModelId: '모델',
    setAiApiKey: 'API 키',
  ...
  fr: {
    ...
    accountRecharge: 'Recharger',
    accountErrNotConfigured: 'Service de compte non configuré',
    accountErrBusy: 'Connexion déjà en cours',
    accountErrCanceled: 'Connexion annulée',
    accountErrTimeout: 'Délai de connexion dépassé',
    accountErrFailed: 'Échec de la connexion',
    accountErrExpired: 'Session expirée, reconnectez-vous',
    accountSection: 'Compte',
    accountSignedOut: 'Non connecté',
    accountBalance: 'Solde',
    accountMonthUsed: 'Utilisé ce mois',
    accountLowBalance: 'Solde faible — rechargez pour continuer à utiliser les fonctions IA',
    accountManagedNote: "Compte Fangtang connecté — les conversations sont facturées à l'usage sur votre solde.",
    // Sidebar navigation
    navRecent: 'Récents',
    navStarred: 'Favoris',
    ...
    setSkillsDesc: 'Choisissez les compétences de génération disponibles dans l’IA de chaque éditeur',
    setWebsite: 'Site web',
    setVisitSite: 'Visiter le site',
  ...
  de: {
    ...
    accountRecharge: 'Aufladen',
    accountErrNotConfigured: 'Konto-Dienst nicht konfiguriert',
    accountErrBusy: 'Anmeldung läuft bereits',
    accountErrCanceled: 'Anmeldung abgebrochen',
    accountErrTimeout: 'Zeitüberschreitung bei der Anmeldung',
    accountErrFailed: 'Anmeldung fehlgeschlagen',
    accountErrExpired: 'Sitzung abgelaufen, bitte neu anmelden',
    accountSection: 'Konto',
    accountSignedOut: 'Nicht angemeldet',
    accountBalance: 'Guthaben',
    accountMonthUsed: 'Diesen Monat verbraucht',
    accountLowBalance: 'Geringes Guthaben — laden Sie auf, um KI-Funktionen weiter zu nutzen',
    accountManagedNote: 'Bei Fangtang angemeldet — Chats werden verbrauchsabhängig vom Guthaben abgerechnet.',
    // Sidebar navigation
    ...
    setSecAbout: 'Über',
    setSecSkills: 'Skills',
    setSkillsDesc: 'Wählen Sie, welche Dokument-Skills in den KI-Chats der Editoren angeboten werden',
    setWebsite: 'Website',
    setVisitSite: 'Website besuchen',
  ...
  es: {
    ...
    accountRecharge: 'Recargar',
    accountErrNotConfigured: 'Servicio de cuenta no configurado',
    accountErrBusy: 'Inicio de sesión en curso',
    accountErrCanceled: 'Inicio de sesión cancelado',
    accountErrTimeout: 'Tiempo de inicio de sesión agotado',
    accountErrFailed: 'Error al iniciar sesión',
    accountErrExpired: 'Sesión caducada, vuelva a iniciar sesión',
    accountSection: 'Cuenta',
    accountSignedOut: 'Sesión no iniciada',
    accountBalance: 'Saldo',
    accountMonthUsed: 'Usado este mes',
    accountLowBalance: 'Saldo bajo: recargue para seguir usando las funciones de IA',
    accountManagedNote: 'Sesión iniciada en Fangtang: los chats se cobran según el uso de tu saldo.',
    // Sidebar navigation
    navRecent: 'Recientes',
    ...
    setSkillsDesc: 'Elija qué habilidades de generación aparecen en el chat de IA de cada editor',
    setWebsite: 'Sitio web',
    setVisitSite: 'Visitar el sitio',
  ...
  th: {
    ...
    accountRecharge: 'เติมเงิน',
    accountErrNotConfigured: 'บริการบัญชียังไม่ได้ตั้งค่า',
    accountErrBusy: 'กำลังเข้าสู่ระบบ',
    accountErrCanceled: 'ยกเลิกการเข้าสู่ระบบแล้ว',
    accountErrTimeout: 'หมดเวลาเข้าสู่ระบบ โปรดลองอีกครั้ง',
    accountErrFailed: 'เข้าสู่ระบบไม่สำเร็จ โปรดลองอีกครั้ง',
    accountErrExpired: 'เซสชันหมดอายุ โปรดเข้าสู่ระบบอีกครั้ง',
    accountSection: 'บัญชี',
    accountSignedOut: 'ยังไม่ได้ลงชื่อเข้าใช้',
    accountBalance: 'ยอดคงเหลือ',
    accountMonthUsed: 'ใช้ไปเดือนนี้',
    accountLowBalance: 'ยอดคงเหลือต่ำ เติมเงินเพื่อใช้ฟีเจอร์ AI ต่อได้',
    accountManagedNote: 'ลงชื่อเข้าใช้บัญชี Fangtang แล้ว — แชทจะถูกเรียกเก็บเงินตามการใช้งานจากยอดคงเหลือ',
    // Sidebar navigation
    navRecent: 'ล่าสุด',
    ...
    setSecSkills: 'ทักษะ',
    setSkillsDesc: 'เลือกทักษะการสร้างเอกสารที่ใช้ได้ในแชต AI ของแต่ละโปรแกรม',
    setWebsite: 'เว็บไซต์',
    setVisitSite: 'เยี่ยมชมเว็บไซต์',
  ...
  id: {
    ...
    accountRecharge: 'Isi ulang',
    accountErrNotConfigured: 'Layanan akun belum dikonfigurasi',
    accountErrBusy: 'Masuk sedang berlangsung',
    accountErrCanceled: 'Masuk dibatalkan',
    accountErrTimeout: 'Waktu masuk habis, coba lagi',
    accountErrFailed: 'Gagal masuk, coba lagi',
    accountErrExpired: 'Sesi kedaluwarsa, silakan masuk lagi',
    accountSection: 'Akun',
    accountSignedOut: 'Belum masuk',
    accountBalance: 'Saldo',
    accountMonthUsed: 'Terpakai bulan ini',
    accountLowBalance: 'Saldo menipis — isi ulang untuk terus memakai fitur AI',
    accountManagedNote: 'Masuk akun Fangtang — obrolan ditagih dari saldo sesuai pemakaian.',
    // Sidebar navigation
    navRecent: 'Terbaru',
    ...
    setSecGeneral: 'Umum',
    setSecAbout: 'Tentang',
    setSecSkills: 'Keterampilan',
    setSkillsDesc: 'Pilih keterampilan pembuatan dokumen bawaan yang tersedia di obrolan AI tiap editor',
    setWebsite: 'Situs web',
    setVisitSite: 'Kunjungi situs',
  ...
  ru: {
    ...
    accountRecharge: 'Пополнить',
    accountErrNotConfigured: 'Сервис аккаунта не настроен',
    accountErrBusy: 'Вход уже выполняется',
    accountErrCanceled: 'Вход отменён',
    accountErrTimeout: 'Время ожидания входа истекло',
    accountErrFailed: 'Не удалось войти',
    accountErrExpired: 'Сессия истекла, войдите снова',
    accountSection: 'Аккаунт',
    accountSignedOut: 'Не выполнен вход',
    accountBalance: 'Баланс',
    accountMonthUsed: 'Израсходовано за месяц',
    accountLowBalance: 'Мало средств — пополните баланс, чтобы продолжить пользоваться ИИ',
    accountManagedNote: 'Вход выполнен в аккаунт Fangtang — диалоги тарифицируются по использованию с баланса.',
    // Sidebar navigation
    navRecent: 'Недавние',
    ...
    setSecSkills: 'Навыки',
    setSkillsDesc: 'Выберите, какие встроенные навыки генерации доступны в ИИ-чате каждого редактора',
    setWebsite: 'Сайт',
    setVisitSite: 'Открыть сайт',
  ...
  ar: {
    ...
    accountRecharge: 'إعادة الشحن',
    accountErrNotConfigured: 'خدمة الحساب غير مهيأة',
    accountErrBusy: 'تسجيل الدخول قيد التنفيذ',
    accountErrCanceled: 'أُلغيت عملية تسجيل الدخول',
    accountErrTimeout: 'انتهت مهلة تسجيل الدخول',
    accountErrFailed: 'فشل تسجيل الدخول',
    accountErrExpired: 'انتهت صلاحية الجلسة، سجّل الدخول مجددًا',
    accountSection: 'الحساب',
    accountSignedOut: 'لم يتم تسجيل الدخول',
    accountBalance: 'الرصيد',
    accountMonthUsed: 'المستخدم هذا الشهر',
    accountLowBalance: 'الرصيد منخفض — أعد التعبئة لمتابعة استخدام ميزات الذكاء الاصطناعي',
    accountManagedNote: 'تم تسجيل الدخول إلى حساب Fangtang — تُحتسب المحادثات من الرصيد حسب الاستخدام.',
    // Sidebar navigation
    navRecent: 'الأخيرة',
    navStarred: 'المفضلة',
    ...
    setSkillsDesc: 'اختر مهارات الإنشاء المضمنة المتاحة في محادثة الذكاء الاصطناعي لكل محرر',
    setWebsite: 'الموقع الإلكتروني',
    setVisitSite: 'زيارة الموقع',
  ...
  pt: {
    ...
    accountSignOut: 'Sair',
    accountRecharge: 'Recarregar',
    accountErrNotConfigured: 'Serviço de conta não configurado',
    accountErrBusy: 'Entrada em andamento',
    accountErrCanceled: 'Entrada cancelada',
    accountErrTimeout: 'Tempo de entrada esgotado',
    accountErrFailed: 'Falha ao entrar',
    accountErrExpired: 'Sessão expirada, entre novamente',
    accountSection: 'Conta',
    accountSignedOut: 'Sessão não iniciada',
    accountBalance: 'Saldo',
    accountMonthUsed: 'Usado este mês',
    accountLowBalance: 'Saldo baixo — recarregue para continuar usando os recursos de IA',
    accountManagedNote: 'Sessão iniciada na conta Fangtang — os chats são cobrados do saldo conforme o uso.',
    navRecent: 'Recentes',
    ...
    setSecAbout: 'Sobre',
    setSecSkills: 'Habilidades',
    setSkillsDesc: 'Escolha quais habilidades de geração aparecem no chat de IA de cada editor',
    setWebsite: 'Site',
    setVisitSite: 'Visitar o site',
    setSecAiModel: 'Modelo de IA',
  ...
  it: {
    ...
    accountSignOut: 'Esci',
    accountRecharge: 'Ricarica',
    accountErrNotConfigured: 'Servizio account non configurato',
    accountErrBusy: 'Accesso già in corso',
    accountErrCanceled: 'Accesso annullato',
    accountErrTimeout: 'Accesso scaduto, riprova',
    accountErrFailed: 'Accesso non riuscito',
    accountErrExpired: 'Sessione scaduta, accedi di nuovo',
    accountSection: 'Account',
    accountSignedOut: 'Accesso non effettuato',
    accountBalance: 'Saldo',
    accountMonthUsed: 'Usato questo mese',
    accountLowBalance: 'Saldo basso — ricarica per continuare a usare le funzioni IA',
    accountManagedNote: "Accesso effettuato all'account Fangtang — le chat vengono addebitate sul saldo in base all'uso.",
    navRecent: 'Recenti',
    ...
    setSkillsDesc: 'Scegli quali competenze di generazione sono disponibili nella chat IA di ogni editor',
    setWebsite: 'Sito web',
    setVisitSite: 'Visita il sito',
  ...
  pl: {
    ...
    accountRecharge: 'Doładuj konto',
    accountErrNotConfigured: 'Usługa konta nieskonfigurowana',
    accountErrBusy: 'Logowanie w toku',
    accountErrCanceled: 'Logowanie anulowane',
    accountErrTimeout: 'Przekroczono czas logowania',
    accountErrFailed: 'Logowanie nie powiodło się',
    accountErrExpired: 'Sesja wygasła, zaloguj się ponownie',
    accountSection: 'Konto',
    accountSignedOut: 'Nie zalogowano',
    accountBalance: 'Saldo',
    accountMonthUsed: 'Wykorzystano w tym miesiącu',
    accountLowBalance: 'Niskie saldo — doładuj konto, aby korzystać dalej z funkcji AI',
    accountManagedNote: 'Zalogowano do konta Fangtang — rozmowy są rozliczane z salda według użycia.',
    navRecent: 'Ostatnie',
    navStarred: 'Ulubione',
    ...
    setSkillsDesc: 'Wybierz, które wbudowane umiejętności generowania są dostępne na czacie AI każdego edytora',
    setWebsite: 'Strona internetowa',
    setVisitSite: 'Otwórz stronę',
    setSecAiModel: 'Model AI',
  ...
  nl: {
    accountSignIn: 'Aanmelden',
    accountSignOut: 'Afmelden',
    accountRecharge: 'Opladen',
    accountErrNotConfigured: 'Accountservice niet geconfigureerd',
    accountErrBusy: 'Aanmelding loopt al',
    accountErrCanceled: 'Aanmelding geannuleerd',
    accountErrTimeout: 'Aanmelding verlopen',
    accountErrFailed: 'Aanmelding mislukt',
    accountErrExpired: 'Sessie verlopen, meld opnieuw aan',
    accountSection: 'Account',
    accountSignedOut: 'Niet ingelogd',
    accountBalance: 'Saldo',
    accountMonthUsed: 'Deze maand gebruikt',
    accountLowBalance: 'Laag saldo — laad op om AI-functies te blijven gebruiken',
    accountManagedNote: 'Ingelogd bij Fangtang — chats worden naar verbruik van je saldo afgerekend.',
    navRecent: 'Recent',
    ...
    setSecAbout: 'Over',
    setSecSkills: 'Skills',
    setSkillsDesc: 'Kies welke ingebouwde documentskills beschikbaar zijn in de AI-chat van elke editor',
    setWebsite: 'Website',
    setVisitSite: 'Website bezoeken',
    setSecAiModel: 'AI-model',
    setAiProvider: 'Provider',
    setAiModelId: 'Model',
  ...
  ms: {
    accountSignIn: 'Log masuk',
    accountSignOut: 'Log keluar',
    accountRecharge: 'Tambah nilai',
    accountErrNotConfigured: 'Perkhidmatan akaun tidak dikonfigurasi',
    accountErrBusy: 'Log masuk sedang dijalankan',
    accountErrCanceled: 'Log masuk dibatalkan',
    accountErrTimeout: 'Log masuk tamat masa',
    accountErrFailed: 'Log masuk gagal',
    accountErrExpired: 'Sesi telah tamat tempoh, sila log masuk semula',
    accountSection: 'Akaun',
    accountSignedOut: 'Belum log masuk',
    accountBalance: 'Baki',
    accountMonthUsed: 'Digunakan bulan ini',
    accountLowBalance: 'Baki rendah — isi semula untuk terus guna ciri AI',
    accountManagedNote: 'Log masuk akaun Fangtang — sembang dibilkan daripada baki mengikut penggunaan.',
    navRecent: 'Terkini',
    navStarred: 'Berbintang',
    ...
    setSkillsDesc: 'Pilih kemahiran penjanaan terbina dalam yang tersedia dalam sembang AI setiap editor',
    setWebsite: 'Laman web',
    setVisitSite: 'Lawati laman web',
    setSecAiModel: 'Model AI',
    setAiProvider: 'Penyedia',
    setAiModelId: 'Model',
    setAiApiKey: 'Kunci API',
  ...
  he: {
    ...
    accountRecharge: 'טעינת יתרה',
    accountErrNotConfigured: 'שירות החשבון אינו מוגדר',
    accountErrBusy: 'ההתחברות כבר מתבצעת',
    accountErrCanceled: 'ההתחברות בוטלה',
    accountErrTimeout: 'פג הזמן הקצוב להתחברות',
    accountErrFailed: 'ההתחברות נכשלה',
    accountErrExpired: 'פג תוקף ההפעלה, התחברו מחדש',
    accountSection: 'חשבון',
    accountSignedOut: 'לא מחובר',
    accountBalance: 'יתרה',
    accountMonthUsed: 'שימוש החודש',
    accountLowBalance: 'היתרה נמוכה — מלאו כדי להמשיך להשתמש בתכונות ה-AI',
    accountManagedNote: 'מחובר לחשבון Fangtang — הצ׳אטים מחויבים מהיתרה לפי שימוש.',
    navRecent: 'אחרונים',
    navStarred: 'מועדפים',
    ...
    setSecGeneral: 'כללי',
    setSecAbout: 'אודות',
    setSecSkills: 'כישורים',
    setSkillsDesc: 'בחרו אילו כישורי יצירה מובנים יהיו זמינים בצ׳אט ה-AI של כל עורך',
    setWebsite: 'אתר האינטרנט',
    setVisitSite: 'בקרו באתר',
  ...
  hi: {
    accountSignIn: 'साइन इन',
    accountSignOut: 'साइन आउट',
    accountRecharge: 'रिचार्ज',
    accountErrNotConfigured: 'खाता सेवा कॉन्फ़िगर नहीं है',
    accountErrBusy: 'साइन इन पहले से चल रहा है',
    accountErrCanceled: 'साइन इन रद्द हुआ',
    accountErrTimeout: 'साइन इन का समय समाप्त',
    accountErrFailed: 'साइन इन विफल',
    accountErrExpired: 'सत्र समाप्त, कृपया दोबारा साइन इन करें',
    accountSection: 'खाता',
    accountSignedOut: 'साइन इन नहीं',
    accountBalance: 'बैलेंस',
    accountMonthUsed: 'इस माह उपयोग',
    accountLowBalance: 'बैलेंस कम है — AI सुविधाएँ जारी रखने के लिए रिचार्ज करें',
    accountManagedNote: 'Fangtang खाते में साइन इन हैं — चैट का बिल उपयोग के अनुसार बैलेंस से लगेगा।',
    navRecent: 'हाल के',
    navStarred: 'तारांकित',
    ...
    setSecAbout: 'जानकारी',
    setSecSkills: 'कौशल',
    setSkillsDesc: 'चुनें कि प्रत्येक संपादक की AI चैट में कौन से निर्मित जनरेशन कौशल उपलब्ध हों',
    setWebsite: 'वेबसाइट',
    setVisitSite: 'वेबसाइट देखें',
  ...
  'zh-TW': {
    ...
    accountSignOut: '登出',
    accountRecharge: '儲值',
    accountErrNotConfigured: '帳號服務未設定',
    accountErrBusy: '登入進行中，請稍候',
    accountErrCanceled: '已取消登入',
    accountErrTimeout: '登入逾時，請重試',
    accountErrFailed: '登入失敗，請重試',
    accountErrExpired: '登入已過期，請重新登入',
    accountSection: '帳號',
    accountSignedOut: '未登入',
    accountBalance: '餘額',
    accountMonthUsed: '本月已用',
    accountLowBalance: '餘額不足，儲值後可繼續使用 AI 功能',
    accountManagedNote: '已登入方塘帳號，對話將依用量從餘額扣款。',
    navRecent: '最近',
    navStarred: '收藏',
    ...
    setSecAbout: '關於',
    setSecSkills: '技能',
    setSkillsDesc: '選擇各編輯器 AI 對話視窗中可用的內建產生技能',
    setWebsite: '官網',
    setVisitSite: '前往官網',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服務商',
